...
/* ═══════════════════════════════════════════════════════
   OPTIMIZATION: Enable DMA for ~20-30% FPS improvement
   ═══════════════════════════════════════════════════════ */
#define LCD_SPI_DMA

/* ═══════════════════════════════════════════════════════
   TOUCH CALIBRATION - Adjust if touch mapping is wrong
   Default values are for standard T-Display-S3-Long
   ═══════════════════════════════════════════════════════ */
#define TOUCH_MIN_X           10       // Left edge
#define TOUCH_MAX_X           627      // Right edge
#define TOUCH_MIN_Y           0        // Top edge
#define TOUCH_MAX_Y           175      // Bottom edge

#define SCREEN_W              640      // Landscape width
#define SCREEN_H              180      // Landscape height
...
#define SEND_BUF_SIZE         (28800/2) // 14400 pixels per SPI chunk
